...
//cascade = delete children when parent is deleted;restrict ="dont delete the parent if any
...
// restrict = prevent deleting the parent if a child still references it
